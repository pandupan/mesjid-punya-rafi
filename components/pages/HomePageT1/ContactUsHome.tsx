  ...
  return (
      <section id="contact">
        <div className="relative bg-[#d4e7f2] h-auto w-full py-10 flex flex-col lg:flex-row px-4 sm:px-10  justify-center items-center gap-12">
          ...
          <div className="relative border-4 border-[#29895e] w-[295px] h-[277px] sm:w-[395px] sm:h-[377px] lg:w-[595px] lg:h-[477px] mt-16">
          ...
          <div className="flex flex-col gap-5 space-y-1 bg-[#d4e7f2] z-[1]">
            <h1 className="text-[#29895e] text-4xl md:text-6xl lg:text-7xl font-bold">Contact Us</h1>

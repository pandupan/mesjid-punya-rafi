...
const HistoryOfCenter = () => {
  return (
    ...
    <h1 className="text-theme-secondary text-3xl sm:text-5xl xl:text-6xl font-bold">History Of Center</h1>
      ...
      <button className="bg-[#34af78] w-[154px] h-[43px] rounded-xl mt-2">
      <a className="place-self-center">Learn More</a>
    </button>
    </div>

    <div className="relative border-4 border-[#29895e] w-[270px] h-[270px] sm:w-[470px] sm:h-[470px] lg:w-[400px] lg:h-[400px] xl:w-[523px] xl:h-[523px] ">
      <div>
